...
import sty from "./PlasmicButton.module.css"; // plasmic-import: jCiHQkUtwa1/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: dTtTC6zw9_M/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: zoW0V_gsSsu/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__x3Grh)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__hhTo)}
                role={"img"}
              />
            ),
